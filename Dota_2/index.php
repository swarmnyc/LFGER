...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $tweet = "#LFG #Dota2" . " ~ gamertag: " . $_POST['gamertag'] . " ~ " . $_POST['notes'] . "~" . CURRENT_PAGE . "?region=" . urlencode($_POST['region']). "&platform=" . urlencode($_POST['platform']) . "&level=" . $_POST['level'] . "&event=" . urlencode($_POST['event'])  . "&gamertag=" . urlencode($_POST['gamertag']) . "&notes=" . urlencode($_POST['notes']) . "&time=" . urlencode(time());
...
<!DOCTYPE html>
<html lang="en" style="background: url(../img/dotaBig.jpg) center center fixed no-repeat; background-size: cover;">
<head>
        ...
        <div class="contain-main">
            ...
            <div class="wrapitup">
                ...
                <div id="refresh">
                    <div id="tweets">
                        <ul>
                            <h2>Heroes Looking For Group</h2>
